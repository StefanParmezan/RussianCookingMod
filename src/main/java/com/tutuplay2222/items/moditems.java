...
import com.tutuplay2222.items.LadleItem;
...
public class moditems {
    ...
    public static final RegistryObject<Item> WOODEN_LADLE = ITEMS.register("wooden_ladle",
            () -> new LadleItem(Tiers.WOOD, 6, -3.0F, new Item.Properties()));

    public static final RegistryObject<Item> STONE_LADLE = ITEMS.register("stone_ladle",
            () -> new LadleItem(Tiers.STONE, 7, -3.0F, new Item.Properties()));

    public static final RegistryObject<Item> IRON_LADLE = ITEMS.register("iron_ladle",
            () -> new LadleItem(Tiers.IRON, 6, -3.0F, new Item.Properties()));

    public static final RegistryObject<Item> GOLDEN_LADLE = ITEMS.register("golden_ladle",
